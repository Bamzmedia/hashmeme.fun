    ...
    return (
        <main className="min-h-screen bg-[#05070a] text-white flex flex-col font-sans selection:bg-blue-500 selection:text-white relative">
            ...
            <section className="h-screen flex flex-col items-center justify-center px-6 relative z-10 pt-20">
                ...
                >
                    <div className="inline-flex items-center space-x-3 px-6 py-2 frosted rounded-full text-[10px] font-bold tracking-[0.4em] uppercase text-blue-400">
                    ...
                    <div className="flex flex-col items-center justify-center pt-8 gap-12">
                        <div className="p-1 frosted rounded-full">
                            <WalletConnectButton />
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                            <button 
                                ...
                                className="w-full sm:w-auto px-16 py-6 border-2 border-blue-500 text-white font-black text-[10px] uppercase tracking-[0.3em] hover:bg-blue-500 transition-all shadow-neon-blue active:scale-95"
                            >
                                Explore Market
                            </button>
                            <Link href="/dashboard" className="w-full sm:w-auto">
                                <button className="w-full sm:w-auto px-16 py-6 border border-white/10 text-white/30 font-black text-[10px] uppercase tracking-[0.3em] hover:border-white hover:text-white transition-all active:scale-95">
                                    Create Asset
                                </button>
                            </Link>
                        </div>
            ...
            <section id="market-section" className="max-w-[1700px] mx-auto w-full px-8 py-32 flex flex-col lg:flex-row gap-16 relative z-10">
                ...
                <aside className="w-full lg:w-[450px] flex flex-col space-y-12">
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="frosted p-10 space-y-10 rounded-[3rem] shadow-neon-blue-lg"
                    >
                        <div className="space-y-4">
                            <h3 className="text-[10px] font-bold text-white/30 uppercase tracking-widest relative z-10">Protocol Velocity (24H)</h3>
                            <div className="text-5xl font-black tracking-tighter relative z-10">{stats.dailySwaps}</div>
