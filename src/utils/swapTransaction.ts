 ...
 */
export async function buildSaucerSwapTx(
    ...
    // Dynamic import to avoid SSR errors during build
    const { ContractExecuteTransaction, ContractId, Hbar, ContractFunctionParameters } = await import('@hashgraph/sdk');
